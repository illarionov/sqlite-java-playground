...
fun pathRemoveDirectory(
    ...
    handle = PathRemoveDirectory(filesystem)
)

private class PathRemoveDirectory(
    fileSystem: FileSystem,
    private val logger: Logger = Logger.getLogger(PathRemoveDirectory::class.qualifiedName),
) : WasiHostFunction {
