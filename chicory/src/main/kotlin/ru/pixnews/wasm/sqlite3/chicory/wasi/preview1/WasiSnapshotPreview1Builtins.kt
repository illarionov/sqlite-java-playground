...
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.fdFdstatGet
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.fdFdstatSetFlags
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.fdFilestatGet
...
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathFilestatSetTimes
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathLink
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathOpen
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathReadlink
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathRemoveDirectory
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathRename
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathSymlink
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.pathUnlinkFile
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.randomGet
import ru.pixnews.wasm.sqlite3.chicory.wasi.preview1.func.schedYield
