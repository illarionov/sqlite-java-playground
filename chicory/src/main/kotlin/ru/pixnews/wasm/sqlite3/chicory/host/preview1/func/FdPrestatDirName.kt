...
fun fdPrestatDirName(
    ...
    handle = FdPrestatDirName(filesystem)
)

private class FdPrestatDirName(
    fileSystem: FileSystem,
    private val logger: Logger = Logger.getLogger(FdPrestatDirName::class.qualifiedName),
