...
fun pathCreateDirectory(
    ...
    handle = PathCreateDirectory(filesystem)
)

private class PathCreateDirectory(
    fileSystem: FileSystem,
    private val logger: Logger = Logger.getLogger(PathCreateDirectory::class.qualifiedName),
) : WasiHostFunction {
